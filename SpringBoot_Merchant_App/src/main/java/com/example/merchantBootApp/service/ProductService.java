...
import com.example.merchantBootApp.dao.MerchantDao;
import com.example.merchantBootApp.dao.ProductDao;
...
import com.example.merchantBootApp.exception.IdNotFoundException;
import com.example.merchantBootApp.exception.InvalidCredentialsException;
import com.example.merchantBootApp.exception.ProductNotFoundException;
...
public class ProductService {
	...
	public ResponseEntity<ResponseStructure<Product>> saveProduct(Product product, int merchant_id) {
		...
		if (recMerchant.isPresent()) {
			...
			product.setMerchant(merchant);          //setting Merchant To Product
		...
		throw new IdNotFoundException("Inavalid ID");
	}
